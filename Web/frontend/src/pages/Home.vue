    ...
    <main class="flex flex-wrap p-2 lg:p-20">
            ...
            <div class="hidden lg:flex lg:mt-6">
                <Card class="mr-6 w-1/2">
                    <header class="w-full flex justify-between items-center mx-10 mt-10">
                        <h2 class="uppercase text-black-3">Number of vehicles in action</h2>
                    </header>
                    <section class="mb-10 mx-10">
                        <h3 class="text-6xl text-left"> 6 <span class="text-2xl">Cars</span></h3>
                ...
                <Card class="mr-6  w-1/2">
                    ...
                    <section class="mb-10 mx-10">
                        <h3 class="text-6xl text-left">28.3<span class="text-2xl">km</span></h3>
        ...
        <Card class="w-full lg:w-1/2">
            <header class="w-full flex justify-between items-center m-5 md:m-10">
                <h2 class="uppercase text-black-3">Remote sensing</h2>
            </header>
    ...
    data() {
      return {
        operatingCard: {
          ...
          content: 'The car is operating well. Pressure, temperature, humidity are all good.'
        },
        graphCard: {
